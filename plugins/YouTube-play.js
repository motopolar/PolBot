...
if (!text) throw `*Escribe el comando junto al nombre del artista y la canción, por ejemlo:*${usedPrefix + command} Rosalía Tuya* `
try {
...
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `_PolBot✍_`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {  
try {
